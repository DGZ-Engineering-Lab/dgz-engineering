...
class Rotator {
    constructor(config) {
        ...
        this.CLIENT_ID = config.clientId || 'YOUR_CLIENT_ID_HERE.apps.googleusercontent.com';
        this.CLIENT_SECRET = config.clientSecret || 'GOCSPX-YOUR_CLIENT_SECRET_HERE';
        this.DEFAULT_PROJECT_ID = config.defaultProjectId || 'YOUR_PROJECT_ID';
