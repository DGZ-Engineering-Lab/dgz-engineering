...
export default function OperationalWorkflow() {
  ...
  return (
    <section className="relative w-full py-32 z-10 bg-[#020406] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-20 space-y-4">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white tracking-tighter">De la Complejidad a la <span className="text-cyan-400">Eficiencia</span></h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {steps.map((step, i) => (
            <div key={i} className="relative group">
              ...
              <div className={`h-full p-10 rounded-3xl border border-slate-800/50 bg-gradient-to-br ${step.color} backdrop-blur-xl relative overflow-hidden transition-all duration-500 hover:border-slate-700 hover:-translate-y-2 hover:shadow-2xl`}>
        ...
        {/* Integration Callout */}
        <div className="mt-20 p-10 rounded-3xl border border-slate-800 bg-slate-900/20 backdrop-blur-md flex flex-col lg:flex-row items-center gap-12 group">
           <div className="flex-1 space-y-4">
             ...
             <p className="text-slate-500 text-lg font-light leading-relaxed">Nuestra metodología no es solo técnica; es una respuesta directa a las necesidades operativas de los gestores territoriales que buscan <span className="text-white">resultados sin burocracia</span>.</p>
           </div>
