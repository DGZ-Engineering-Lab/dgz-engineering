    ...
    <section className="py-32 bg-white text-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
           {points.map((p, i) => (
              <div key={i} className="group p-10 bg-slate-50 rounded-[3rem] border border-slate-100 hover:bg-white hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                 ...
                 <div className="space-y-4">
                    ...
                    <h3 className="text-3xl font-black tracking-tight text-slate-900">{p.title}</h3>
        ...
        <div className="mt-24 p-12 bg-slate-900 rounded-[3rem] text-white flex flex-col md:flex-row items-center justify-between gap-12">
           <div className="space-y-4 text-center md:text-left">
              <h3 className="text-4xl font-black tracking-tight">¿Listo para modernizarse?</h3>
              <p className="text-slate-400 font-light text-lg">Hacemos que lo complejo se vuelva invisible para que usted se enfoque en los resultados.</p>
           </div>
           <a href="#contact" className="px-10 py-5 bg-white text-black font-black text-xs uppercase tracking-widest rounded-2xl hover:bg-blue-500 hover:text-white transition-all shadow-xl">
